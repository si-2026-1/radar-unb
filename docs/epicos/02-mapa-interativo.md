...
**Descrição:**  
Este épico trata do "coração" visual da aplicação: a renderização do mapa, o consumo das coordenadas e a interface de busca. É aqui que os usuários ganham consciência situacional do campus.
